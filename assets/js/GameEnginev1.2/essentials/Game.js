...
class GameCore {
    ...
    async _initializeGameControlAsync(gameLevelClasses) {
        try {
            const mod = await import(`${this.path}/assets/js/GameEnginev1.2/essentials/GameControl.js`);
    ...
    _initializePauseFeature() {
        ...
        try {
            // v1.2 stores the pause code in PauseMenu.js (not "PauseFeature").
            import(`${this.path}/assets/js/GameEnginev1.2/essentials/PauseMenu.js`).then(mod => {
    ...
    _handleToggleLeaderboard() {
        ...
        if (leaderboardContainer) {
            ...
            if (EnvLeaderboardClass) {
                ...
                import(`${this.path}/assets/js/GameEnginev1.2/essentials/Leaderboard.js`)
