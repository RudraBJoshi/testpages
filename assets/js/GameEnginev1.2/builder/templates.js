...
(function (global) {
  ...
  tpl.playerData = function ({ name, p, ui, keypress, bg, rigidBody }) {
    const hitboxModeLine = rigidBody ? `\n            hitboxMode: 'rigidBody',` : '';
    return `// [TEMPLATE CODE] GameTemplatesV1.1.playerData\nconst playerData = {
            ...
            hitbox: { widthPercentage: 0.45, heightPercentage: 0.2 },${hitboxModeLine}
            keypress: ${keypress}
        };`;
  };
